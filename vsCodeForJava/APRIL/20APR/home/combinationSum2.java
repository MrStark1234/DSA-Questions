...
// To solve this problem, we can use a recursive backtracking 
// approach. We iterate through the candidates array and try 
// different combinations to reach the target sum. If the target 
// sum is achieved, we add the combination to the result.
